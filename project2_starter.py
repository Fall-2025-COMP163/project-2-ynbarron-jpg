...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        """
        damage = self.strength + 5  # bonus for warrior
...
class Mage(Player):
    ...
    def attack(self, target):
        ...
        """
        damage = self.magic
        print(f"{self.name} casts a avearge spell on {target.name} for {damage} magic damage!")
        target.take_damage(damage)
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        if crit_chance <= 3:
            damage *= 2
            print(f"{self.name} lands a vital hit on {target.name} for {damage} damage!")
        else:
    ...
    def sneak_attack(self, target):
        ...
        """
        damage = self.strength * 2
        print(f"{self.name} performs a ambush attack on {target.name} for {damage} damage!")
        target.take_damage(damage)
